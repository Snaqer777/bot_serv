...
def terms_text() -> str:
    ...
    Длина текста ~3,7 КБ: умещается в одно сообщение Telegram (лимит 4096 символов).
    ...
    return (
        ...
        "3.1. Оплата производится через встроенные платёжные методы Telegram (CryptoBot, "
        "Telegram Stars) или иные способы, указанные в боте.\n"
